...
# Read in the file(s)
i = 0
filelist = glob.glob(os.path.join('/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023052300/', 'wrfout_d02_2023-*:00:00'))
#filelist = ['/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023041800/wrfout_d02_2023-04-18_01:00:00']
print(filelist)
...
for filename in sorted(filelist):
    if i >-1:
        ...
        lat1 = [35.54122]
        lon1 = [-97.95494]
        plt.plot(lon1, lat1, 'm*', label = name, transform=crs.PlateCarree())            
        ...
        #Add county lines so the map looks more complete.
        ...
        ax.set_extent([-99, -96.5, 34.85, 35.85], crs=crs.PlateCarree()) 
        ...
        ax.set_xticks([-96.5, -97, -97.5, -98, -98.5, -99])
        
        ax.set_yticks([35, 35.2, 35.4, 35.6, 35.8])
        
        # This line allows us to put our points on the right side of our plot as well.
        
        secax = ax.secondary_yaxis(1.0)
        secax.set_yticks([35, 35.2, 35.4, 35.6, 35.8])        
        ...
        figname='wrfout_d02_CH4_BIO+ANT+Wet+agwaste_python'+str(i)+'.png'
        print(figname)
