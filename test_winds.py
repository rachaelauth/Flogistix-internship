...
# Read in the file(s) - change for domain 2 
filelist = ['/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023041800/wrfout_d03_2023-04-18_01:00:00']
i = 0
for filename in sorted(filelist):
    if i==0:
	   ...
	   # Doing the math so that we can get the data to be accurate.     
        ...
        # If you want full color plot comment out the lines with cropped in it.            
            ...
            m = plt.contourf(xx, yy, to_np(wspd),levels = 20,
        ...
        cb.set_label("Wind Speed (mph)",y=-100,fontsize=6, rotation=0)
        ...
        #qk = plt.quiverkey(Q, .95, 1.05, 15, r'15 mph', labelpos='W', labelsep = 0.05, coordinates = 'axes')
 ...
 # This is a manual way for you to be able to add the lat and lon points onto the plot.
        ...
        #ax.set_xticks([-96.5, -97, -97.5, -98, -98.5, -99]) domain 2
        
        #ax.set_yticks([35, 35.2, 35.4, 35.6, 35.8]) domain 2
        ...
        #secax.set_yticks([35, 35.2, 35.4, 35.6, 35.8])  domain 2   
        ...
        figname='wrfout_d03_CH4_BIO+ANT+Wet+agwaste_python'+str(i)+'.png' #change for domain 2
        print(figname)
