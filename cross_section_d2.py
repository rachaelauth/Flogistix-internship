...
# Read in the file(s)
i = 0
filelist = glob.glob(os.path.join('/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023041800', 'wrfout_d02_2023-*:00:00'))
...
for filename in sorted(filelist): 
    if i > -1:
        ...
        # Taking the wind cross sections for the wind vectors
        ...
        qk = plt.quiverkey(Q, .95, 1.025, 20, r'$20 \frac{m}{s}$', labelpos='W', labelsep = 0.075, coordinates = 'axes')
        ...
        figname='wrfout_d02_CH4_BIO+ANT+Wet+agwaste_python_cross_section'+str(i)+'.png'
        print(figname)
