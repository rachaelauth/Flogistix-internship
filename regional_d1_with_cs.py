...
from metpy.plots import USCOUNTIES import metpy.calc as mpcalc
...
#filelist = ['/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023041800/wrfout_d03_2023-04-18_01:00:00'] 
print(filelist) print("retrieved all wrfout files") for filename in sorted(filelist):
    if i >-1:
        print(filename)
        ...
        ax.set_extent([-122, -68, 25, 50], crs=crs.PlateCarree())  
