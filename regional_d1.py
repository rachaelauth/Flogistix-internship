...
i = 0
filelist = glob.glob(os.path.join('/scratch/01178/tg804586/Run/CO2_and_otherGHG/WRFV4.3.3/CONUS/wrfchem4.3.3LES3d_Hu2021JGR_CH4NEI2017_Wetchart131_agwasteOce.2023041800/', 'wrfout_d01_2023-*:00:00'))
...
#We then begin to iterate each hour.
        ...
        # Add a start of the city of El Reno
        name =['El Reno']
        lat1 = [35.54122]
        lon1 = [-97.95494]
        ...
        Q=ax.quiver(XLon[skip], XLat[skip], U_Wind[skip], V_Wind[skip],scale = 150, width= .002, transform = crs.PlateCarree())
        ...
        figname='wrfout_d01_CH4_BIO+ANT+Wet+agwaste_python'+str(i)+'.png'
        print(figname)
